...
if ENABLE_LAMPS then
  ...
  for color,rgb in pairs(COLOR_TABLE) do
    ...
    lamp.picture_off.layers[1].hr_version.filename = MOD_NAME.."/graphics/lamp/"..color.."/hr-lamp.png"
    lamp.picture_on.filename            = MOD_NAME.."/graphics/lamp/"..color.."/lamp-light.png"
    lamp.picture_on.hr_version.filename = MOD_NAME.."/graphics/lamp/"..color.."/hr-lamp-light.png"
